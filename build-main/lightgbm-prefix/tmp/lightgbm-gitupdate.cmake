...
execute_process(
  COMMAND "/usr/bin/git" show-ref "e4231205a3bac13662a81db9433ddaea8924fbce"
  WORKING_DIRECTORY "/workspace/build-main/lightgbm-prefix/src/lightgbm"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "e4231205a3bac13662a81db9433ddaea8924fbce")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("e4231205a3bac13662a81db9433ddaea8924fbce" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/e4231205a3bac13662a81db9433ddaea8924fbce")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspace/build-main/lightgbm-prefix/src/lightgbm'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/build-main/lightgbm-prefix/src/lightgbm'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
